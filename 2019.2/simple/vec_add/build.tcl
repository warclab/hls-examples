...
add_files "./src/vec_add.cpp" -cflags "-I ./include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags "-I ./include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "./test/vec_add_tb.cpp" -cflags "-I ./include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags "-I ./include -I ./ -D__SDSVHLS__ -std=c++0x"
set_top vec_add
