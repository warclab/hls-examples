...
add_files "./src/axis_erosion.cpp" -cflags "-I${XF_PROJ_ROOT}/vision/L1/include -I ./include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags "-I${XF_PROJ_ROOT}/vision/L1/include -I ./include -I ./ -D__SDSVHLS__ -std=c++0x"
add_files -tb "./test/axis_erosion_tb.cpp" -cflags "-I${OPENCV_INCLUDE} -I${XF_PROJ_ROOT}/vision/L1/include -I ./include -I ./ -D__SDSVHLS__ -std=c++0x" -csimflags "-I${XF_PROJ_ROOT}/vision/L1/include -I ./include -I ./ -D__SDSVHLS__ -std=c++0x"
set_top sobel_accel
