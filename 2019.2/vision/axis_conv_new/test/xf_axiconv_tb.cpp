...
#define PTYPE CV_8UC3 // Should be CV_16S when ddepth is CV_16S
    ...
    cv::addWeighted(c_grad_x_1, 0.5, c_grad_y_1, 0.5, 0, diff_grad);
    ...
    xfMat2axistream<IN_TYPE,HEIGHT,WIDTH,NPCC>(imgInput, input_stream);
    axiconv_accel(input_stream, output_stream, HEIGHT, WIDTH);
    axistream2xfMat<IN_TYPE,HEIGHT,WIDTH,NPCC>(output_stream, imgOutput);
